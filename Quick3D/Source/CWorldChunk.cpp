...
void CWorldChunk::setGeoloc(Math::CGeoloc gGeoloc)
{
...
void CWorldChunk::setSize(Math::CGeoloc value)
{
	m_gSize = value;
...
CBoundingBox CWorldChunk::createBoundsForTerrain(Math::CGeoloc gPosition, Math::CGeoloc gSize, double dAltitudeFactor)
{
