...
{
    dumpIndented(stream, iIdent, QString("[CController]"));
    dumpIndented(stream, iIdent, QString("Use mouse : %1").arg(m_bUseMouse));
    dumpIndented(stream, iIdent, QString("Move speed : %1").arg(m_dMoveSpeed));
    dumpIndented(stream, iIdent, QString("Force factor : %1").arg(m_dForceFactor));
