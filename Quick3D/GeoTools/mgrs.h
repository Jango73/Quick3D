...
long Make_MGRS_String (char* MGRS, 
                       ...
                       long Precision);
/*
 *  The function Make_MGRS_String creates a formates string in MGRS format.
 *
 *    MGRS          : MGRS coordinate string           (output)
 *    Zone    : Hemisphere either 'N' or 'S'     (input)
 *	  Letters       : number of the letter in the alphabet
 *    Easting       : Easting/X in meters              (input)
 *    Northing      : Northing/Y in meters             (input)
 *	  Precision	    : Number of digits of Easting and Northing (input)
 */
