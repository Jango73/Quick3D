...
namespace Math
{
	...
	CGeoloc::CGeoloc (const CGeoloc& Target)
	{
		*this = Target;
	}
	...
	CGeoloc& CGeoloc::operator = (const CGeoloc& Target)
	{
	...
	bool CGeoloc::operator == (const CGeoloc& Target)
	{
		double dDiffLatitude = fabs(Latitude - Target.Latitude);
		double dDiffLongitude = fabs(Longitude - Target.Longitude);
		double dDiffAltitude = fabs(Altitude - Target.Altitude);
