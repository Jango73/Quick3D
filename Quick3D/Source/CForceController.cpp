...
void CForceController::update(double dDeltaTime)
{
	...
	{
		CPhysicalComponent* pPhysicalPositionTarget = dynamic_cast<CPhysicalComponent*>(m_rPositionTarget.component());
	...
	{
		CPhysicalComponent* pPhysicalRotationTarget = dynamic_cast<CPhysicalComponent*>(m_rRotationTarget.component());

		if (pPhysicalRotationTarget != NULL)
		{
