...
void main()
{
    ...
    // Assign varyings
    vo_position = vertex_pos.xyz;
    vo_distance = distance;

    if (!bool(u_rendering_shadows))
    {
        vo_normal = normal.xyz;
        vo_tangent = tangent.xyz;
        vo_binormal = binormal.xyz;
        vo_texcoord = a_texcoord;
        vo_shadow_coord = shadow_coord;
        vo_altitude = a_altitude;

        vo_difftex_weight_0 = a_difftext_weight_0_1_2.x;
        vo_difftex_weight_1 = a_difftext_weight_0_1_2.y;
        vo_difftex_weight_2 = a_difftext_weight_0_1_2.z;
        vo_difftex_weight_3 = a_difftext_weight_3_4_5.x;
        vo_difftex_weight_4 = a_difftext_weight_3_4_5.y;
        vo_difftex_weight_5 = a_difftext_weight_3_4_5.z;
        vo_difftex_weight_6 = a_difftext_weight_6_7_8.x;
        vo_difftex_weight_7 = a_difftext_weight_6_7_8.y;
    }
